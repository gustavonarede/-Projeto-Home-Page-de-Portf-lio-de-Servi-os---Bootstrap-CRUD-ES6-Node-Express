...
module.exports = class PortfolioModel{
    ...
    static getTodos(callback){
        db.query("SELECT * FROM portfolio", callback);
    }
    ...
    static editar(portfolio,callback){
        return db.query("UPDATE portfolio SET descricao = ?, detalhes = ? WHERE id_portfolio = ?", [portfolio.descricao, portfolio.detalhes, portfolio.id_portfolio,]
        , callback)
    }
};
